#!/usr/bin/env python3
"""
Test intermediate_h5_path handling in SLURM submission script.
"""
...
scripts_dir = Path(__file__).parent.parent.parent.parent / "scripts" / "slurm"
...
def test_intermediate_h5_path_empty_string_from_config():
    ...
    try:
        ...
        print("✓ Empty string intermediate_h5_path normalized to None in SLURM config")
...
if __name__ == '__main__':
    ...
    print("\nAll SLURM intermediate_h5_path tests passed!")
