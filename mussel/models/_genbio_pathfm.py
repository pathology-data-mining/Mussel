# This file is vendored from https://github.com/genbio-ai/genbio-pathfm
# (genbio_pathfm/model.py) under the GenBio AI Community License (non-commercial
# research use).  See https://github.com/genbio-ai/genbio-pathfm/blob/main/LICENSE.txt
# Modifications: removed print() in GenBio_PathFM_Inference.__init__.
import logging
import math
